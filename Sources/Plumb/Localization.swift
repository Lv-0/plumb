...
enum L10n {
    ...
    static let table: [AppLanguage: [Key: String]] = [
        .en: [
            ...
            .hideStatusBarIconHint: "When hidden, open Plumb twice in a row (within 10s) to reopen Settings.",
            .tabAbout: "About",
        ...
        .es: [
            ...
            .hideStatusBarIconHint: "Cuando está oculto, abre Plumb dos veces seguidas (en menos de 10s) para volver a abrir Ajustes.",
            .tabAbout: "Acerca de",
        ...
        .fr: [
            ...
            .hideStatusBarIconHint: "Lorsque masquée, ouvrez Plumb deux fois de suite (sous 10s) pour rouvrir les Réglages.",
            .tabAbout: "À propos",
            .aboutVersion: "Version",
            .aboutGitHub: "GitHub",
        ...
        .zh: [
            ...
            .hideStatusBarIconHint: "隐藏后，连续两次打开 Plumb（间隔 10 秒内）即可重新进入设置。",
            .tabAbout: "关于",
            .aboutVersion: "版本",
            .aboutGitHub: "GitHub",
        ...
        .ja: [
            ...
            .hideStatusBarIconHint: "非表示の時、Plumb を連続して 2 回（10 秒以内に）開くと設定を再度開けます。",
            .tabAbout: "について",
            .aboutVersion: "バージョン",
            .aboutGitHub: "GitHub",
