...
enum L10n {
    ...
    static let table: [AppLanguage: [Key: String]] = [
        .en: [
            ...
            .hideStatusBarIconHint: "When hidden, open the running Plumb app again to reopen Settings.",
            .tabAbout: "About",
        ...
        .es: [
            ...
            .hideStatusBarIconHint: "Cuando está oculto, vuelve a abrir Plumb mientras se está ejecutando para abrir Ajustes.",
            .tabAbout: "Acerca de",
        ...
        .fr: [
            ...
            .hideStatusBarIconHint: "Lorsque masquée, ouvrez à nouveau Plumb pendant son exécution pour rouvrir les Réglages.",
            .tabAbout: "À propos",
            .aboutVersion: "Version",
            .aboutGitHub: "GitHub",
        ...
        .zh: [
            ...
            .hideStatusBarIconHint: "隐藏后，再次打开已运行的 Plumb 即可重新进入设置。",
            .tabAbout: "关于",
            .aboutVersion: "版本",
            .aboutGitHub: "GitHub",
        ...
        .ja: [
            ...
            .hideStatusBarIconHint: "非表示の時、実行中の Plumb をもう一度開くと設定を再度開けます。",
            .tabAbout: "について",
            .aboutVersion: "バージョン",
            .aboutGitHub: "GitHub",
